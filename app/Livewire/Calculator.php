...
class Calculator extends Component
{
    ...
    public function getAllServices()
    {
        return [
            'malowanie' => [
                ['id' => 1, 'name' => 'Gruntowanie ścian', 'unit' => 'm²', 'suggested_price' => 18.00],
                ['id' => 2, 'name' => 'Gruntowanie sufitów', 'unit' => 'm²', 'suggested_price' => 12.00],
                ['id' => 3, 'name' => 'Aplikacja gładzi szpachlowej. 1 wartswa', 'unit' => 'm²', 'suggested_price' => 8.00],
                ['id' => 4, 'name' => 'Aplikacja gładzi szpachlowej. 2 wartswy', 'unit' => 'm²', 'suggested_price' => 25.00],
                ['id' => 5, 'name' => 'Aplikacja farby gruntującej', 'unit' => 'm²', 'suggested_price' => 22.00],
                ['id' => 6, 'name' => 'Aplikacja akryli', 'unit' => 'm²', 'suggested_price' => 20.00],
                ['id' => 7, 'name' => 'Dwukrotne malowanie ścian', 'unit' => 'm²', 'suggested_price' => 35.00],
                ['id' => 8, 'name' => 'Dwukrotne malowanie sufitów', 'unit' => 'szt', 'suggested_price' => 80.00],
            ],
            'glazura' => [
                ...
                ['id' => 18, 'name' => 'Cięcie płytek pod kątem 45 stopni', 'unit' => 'mb', 'suggested_price' => 20.00],
                ['id' => 20, 'name' => 'Aplikacja silikonu', 'unit' => 'mb', 'suggested_price' => 30.00],
            ],
            'glazura w łazience/armatura' => [
                ['id' => 13, 'name' => 'Układanie płytek ściennych (format do 30x30, nie rektyfikowane)', 'unit' => 'm²', 'suggested_price' => 50.00],
                ['id' => 13, 'name' => 'Układanie płytek ściennych (format od 30x30 do 30x 60, nie rektyfikowane)', 'unit' => 'm²', 'suggested_price' => 50.00],
                ['id' => 13, 'name' => 'Układanie płytek ściennych (format od 60x60, rektyfikowane, fuga do 2mm)', 'unit' => 'm²', 'suggested_price' => 50.00],
                ['id' => 18, 'name' => 'Cięcie płytek pod kątem 45 stopni', 'unit' => 'mb', 'suggested_price' => 20.00],
                ['id' => 20, 'name' => 'Otowry w płytkach', 'unit' => 'szt', 'suggested_price' => 30.00],
                ['id' => 20, 'name' => 'Aplikacja silikonu', 'unit' => 'mb', 'suggested_price' => 30.00],
            ],
            'elektryka' => [
